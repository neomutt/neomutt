...
const struct Command EmailCommands[] = {
  // clang-format off
  { "alternative-order", CMD_ALTERNATIVE_ORDER, parse_list,
  ...
  { "auto-view", CMD_AUTO_VIEW, parse_list,
  ...
  { "ignore", CMD_IGNORE, parse_ignore,
  ...
  { "unalternative-order", CMD_UNALTERNATIVE_ORDER, parse_unlist,
        ...
        "mimesupport.html#alternative-order" },
  { "unauto-view", CMD_UNAUTO_VIEW, parse_unlist,
  ...
  { "unheader-order", CMD_UNHEADER_ORDER, parse_unlist,
        ...
        "configuration.html#header-order" },
  { "unignore", CMD_UNIGNORE, parse_unignore,
  ...
  { "unmailto-allow", CMD_UNMAILTO_ALLOW, parse_unlist,
        ...
        "configuration.html#mailto-allow" },
  { "unscore", CMD_UNSCORE, parse_unscore,
        N_("Remove scoring rules for matching patterns"),
        N_("unscore { * | <pattern> ... }"),
        "configuration.html#score-command" },

  // Deprecated
  { "alternative_order",   CMD_NONE, NULL, "alternative-order",   NULL, NULL, CF_SYNONYM },
  { "auto_view",           CMD_NONE, NULL, "auto-view",           NULL, NULL, CF_SYNONYM },
  { "hdr_order",           CMD_NONE, NULL, "header-order",        NULL, NULL, CF_SYNONYM },
  { "mailto_allow",        CMD_NONE, NULL, "mailto-allow",        NULL, NULL, CF_SYNONYM },
  { "unalternative_order", CMD_NONE, NULL, "unalternative-order", NULL, NULL, CF_SYNONYM },
  { "unauto_view",         CMD_NONE, NULL, "unauto-view",         NULL, NULL, CF_SYNONYM },
