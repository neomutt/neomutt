...
static const struct Command MuttCommands[] = {
  ...
  { "hdr-order", CMD_HDR_ORDER, parse_stailq, IP &HeaderOrderList,
        N_("Define custom order of headers displayed"),
        N_("hdr-order <header> [ <header> ... ]"),
  ...
  { "my-hdr", CMD_MY_HDR, parse_my_hdr, CMD_NO_DATA,
  ...
  { "ungroup", CMD_UNGROUP, parse_group, CMD_NO_DATA,
        ...
        "configuration.html#addrgroup" },
  { "unhdr-order", CMD_UNHDR_ORDER, parse_unstailq, IP &HeaderOrderList,
        N_("Remove header from 'hdr-order' list"),
        N_("unhdr-order { * | <header> ... }"),
        "configuration.html#hdr-order" },
  { "unignore", CMD_UNIGNORE, parse_unignore, CMD_NO_DATA,
        N_("Remove a header from the 'hdr-order' list"),
        N_("unignore { * | <string> ... }"),
        "configuration.html#ignore" },
  ...
  { "unmono", CMD_UNMONO, parse_unmono, CMD_NO_DATA,
        ...
        "configuration.html#color-mono" },
  { "unmy-hdr", CMD_UNMY_HDR, parse_unmy_hdr, CMD_NO_DATA,
        N_("Remove a header previously added with 'my-hdr'"),
        N_("unmy-hdr { * | <field> ... }"),
        "configuration.html#my-hdr" },
  ...
  { "hdr_order",           CMD_NONE, NULL, IP "hdr-order",           NULL, NULL, NULL, CF_SYNONYM },
  ...
  { "my_hdr",              CMD_NONE, NULL, IP "my-hdr",              NULL, NULL, NULL, CF_SYNONYM },
  ...
  { "unhdr_order",         CMD_NONE, NULL, IP "unhdr-order",         NULL, NULL, NULL, CF_SYNONYM },
  ...
  { "unmy_hdr",            CMD_NONE, NULL, IP "unmy-hdr",            NULL, NULL, NULL, CF_SYNONYM },
