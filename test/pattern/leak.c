...
static void test_one_leak(const char *pattern)
{
  ...
  struct PatternList *p = mutt_pattern_comp(NULL, pattern, 0, err);
  mutt_pattern_free(&p);
...
void test_mutt_pattern_leak(void)
{
  ...
  test_one_leak("~b REGEX");
  test_one_leak("~B REGEX");
  test_one_leak("~c REGEX");
  test_one_leak("~C REGEX");
  test_one_leak("~d <1d");
  test_one_leak("~d <1w");
  test_one_leak("~d <1m");
  ...
  test_one_leak("~d 01/01/2020*30d");
  test_one_leak("~e REGEX");
  test_one_leak("~f REGEX");
  test_one_leak("~h REGEX");
  test_one_leak("~H REGEX");
  test_one_leak("~i REGEX");
  test_one_leak("~I /dev/null");
  test_one_leak("~k");
  test_one_leak("~l");
  test_one_leak("~L REGEX");
  test_one_leak("~m 50-100");
  test_one_leak("~m -5,.");
  test_one_leak("~M REGEX");
  test_one_leak("~n 5-10");
  test_one_leak("~p");
  test_one_leak("~P");
  test_one_leak("~Q");
  test_one_leak("~r <7d");
  test_one_leak("~s REGEX");
  test_one_leak("~t REGEX");
  test_one_leak("~u");
  test_one_leak("~v");
  test_one_leak("~x REGEX");
  test_one_leak("~X >5");
  test_one_leak("~y REGEX");
  test_one_leak("~Y REGEX");
  test_one_leak("~z <10K");
  test_one_leak("~(~P)");
  test_one_leak("~<(~P)");
