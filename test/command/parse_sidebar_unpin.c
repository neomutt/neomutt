/**
 * @file
 * Test code for parse_sidebar_unpin()
 *
 * @authors
...
static const struct Command SidebarUnpin = { "sidebar-unpin", CMD_SIDEBAR_UNPIN, NULL };
...
void test_parse_sidebar_unpin(void)
{
  ...
  for (int i = 0; Tests[i].line; i++)
  {
    ...
    buf_seek(line, 0);
    rc = parse_sidebar_unpin(&SidebarUnpin, line, pc, pe);
