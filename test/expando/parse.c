...
void test_expando_parser(void)
{
  ...
  static const char *TestStrings[][2] = {
    ...
    // Formatting
    { "",       "" },
    { "%X",     "<EXP:(ED_EMAIL,ED_EMA_ATTACHMENT_COUNT)>" },
    { "%5X",    "<EXP:(ED_EMAIL,ED_EMA_ATTACHMENT_COUNT):{5,-1,RIGHT,' '}>" },
    { "%.7X",   "<EXP:(ED_EMAIL,ED_EMA_ATTACHMENT_COUNT):{0,7,RIGHT,'0'}>" },
    { "%5.7X",  "<EXP:(ED_EMAIL,ED_EMA_ATTACHMENT_COUNT):{5,7,RIGHT,'0'}>" },
    { "%-5X",   "<EXP:(ED_EMAIL,ED_EMA_ATTACHMENT_COUNT):{5,-1,LEFT,' '}>" },
    { "%-.7X",  "<EXP:(ED_EMAIL,ED_EMA_ATTACHMENT_COUNT):{0,7,LEFT,'0'}>" },
    { "%-5.7X", "<EXP:(ED_EMAIL,ED_EMA_ATTACHMENT_COUNT):{5,7,LEFT,'0'}>" },
    { "%05X",   "<EXP:(ED_EMAIL,ED_EMA_ATTACHMENT_COUNT):{5,-1,RIGHT,'0'}>" },

    // Conditional (old form)
    { "%?X??",           "<COND:<BOOL(ED_EMAIL,ED_EMA_ATTACHMENT_COUNT)>||>" },
    { "%?X?&?",          "<COND:<BOOL(ED_EMAIL,ED_EMA_ATTACHMENT_COUNT)>||>" },
    { "%?X?AAA?",        "<COND:<BOOL(ED_EMAIL,ED_EMA_ATTACHMENT_COUNT)>|<TEXT:'AAA'>|>" },
    { "%?X?AAA&?",       "<COND:<BOOL(ED_EMAIL,ED_EMA_ATTACHMENT_COUNT)>|<TEXT:'AAA'>|>" },
    { "%?X?&BBB?",       "<COND:<BOOL(ED_EMAIL,ED_EMA_ATTACHMENT_COUNT)>||<TEXT:'BBB'>>" },
    ...
    { "%<[10M?AAA&BBB>", "<COND:<DATE:(ED_EMAIL,ED_EMA_DATE_STRF_LOCAL):10:M>|<TEXT:'AAA'>|<TEXT:'BBB'>>" },
    { "%<[1H?AAA&BBB>",  "<COND:<DATE:(ED_EMAIL,ED_EMA_DATE_STRF_LOCAL):1:H>|<TEXT:'AAA'>|<TEXT:'BBB'>>" },
    { "%<[10H?AAA&BBB>", "<COND:<DATE:(ED_EMAIL,ED_EMA_DATE_STRF_LOCAL):10:H>|<TEXT:'AAA'>|<TEXT:'BBB'>>" },
    { "%<[1d?AAA&BBB>",  "<COND:<DATE:(ED_EMAIL,ED_EMA_DATE_STRF_LOCAL):1:d>|<TEXT:'AAA'>|<TEXT:'BBB'>>" },
    { "%<[10d?AAA&BBB>", "<COND:<DATE:(ED_EMAIL,ED_EMA_DATE_STRF_LOCAL):10:d>|<TEXT:'AAA'>|<TEXT:'BBB'>>" },
    { "%<[1w?AAA&BBB>",  "<COND:<DATE:(ED_EMAIL,ED_EMA_DATE_STRF_LOCAL):1:w>|<TEXT:'AAA'>|<TEXT:'BBB'>>" },
    { "%<[10w?AAA&BBB>", "<COND:<DATE:(ED_EMAIL,ED_EMA_DATE_STRF_LOCAL):10:w>|<TEXT:'AAA'>|<TEXT:'BBB'>>" },
    { "%<[1m?AAA&BBB>",  "<COND:<DATE:(ED_EMAIL,ED_EMA_DATE_STRF_LOCAL):1:m>|<TEXT:'AAA'>|<TEXT:'BBB'>>" },
    { "%<[10m?AAA&BBB>", "<COND:<DATE:(ED_EMAIL,ED_EMA_DATE_STRF_LOCAL):10:m>|<TEXT:'AAA'>|<TEXT:'BBB'>>" },
    { "%<[1y?AAA&BBB>",  "<COND:<DATE:(ED_EMAIL,ED_EMA_DATE_STRF_LOCAL):1:y>|<TEXT:'AAA'>|<TEXT:'BBB'>>" },
    { "%<[10y?AAA&BBB>", "<COND:<DATE:(ED_EMAIL,ED_EMA_DATE_STRF_LOCAL):10:y>|<TEXT:'AAA'>|<TEXT:'BBB'>>" },
