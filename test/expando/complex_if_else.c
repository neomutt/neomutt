...
void test_expando_complex_if_else(void)
{
...

  {
    ...
    check_node_test(node_get_child(if_true_tree, 0), "pre ");
    check_node_expando(node_get_child(if_true_tree, 1), "l", &fmt);
    check_node_test(node_get_child(if_true_tree, 2), "post");
...

  {
    ...
    check_node_test(node_get_child(if_false_tree, 0), "pre ");
    check_node_expando(node_get_child(if_false_tree, 1), "c", &fmt);
    check_node_test(node_get_child(if_false_tree, 2), "post");
  }
