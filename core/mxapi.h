...
#define MUTT_PEEK          (1 << 3) ///< Revert atime back after taking a look (if applicable)
#define MUTT_APPENDNEW     (1 << 4) ///< Set in mx_open_mailbox_append if the mailbox doesn't exist.
