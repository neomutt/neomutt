...
const struct ColorDefinition ColorDefs[] = {
  // clang-format off
  { "attachment",                MT_COLOR_ATTACHMENT,               CRF_SIMPLE },
  { "attach_headers",            MT_COLOR_ATTACH_HEADERS,           CRF_REGEX },
  { "body",                      MT_COLOR_BODY,                     CRF_REGEX },
  { "bold",                      MT_COLOR_BOLD,                     CRF_SIMPLE },
  { "compose_header",            MT_COLOR_COMPOSE_HEADER,           CRF_SIMPLE },
  { "compose_security_both",     MT_COLOR_COMPOSE_SECURITY_BOTH,    CRF_SIMPLE },
  { "compose_security_encrypt",  MT_COLOR_COMPOSE_SECURITY_ENCRYPT, CRF_SIMPLE },
  { "compose_security_none",     MT_COLOR_COMPOSE_SECURITY_NONE,    CRF_SIMPLE },
  { "compose_security_sign",     MT_COLOR_COMPOSE_SECURITY_SIGN,    CRF_SIMPLE },
  { "error",                     MT_COLOR_ERROR,                    CRF_SIMPLE },
  { "hdrdefault",                MT_COLOR_HDRDEFAULT,               CRF_SIMPLE },
  { "header",                    MT_COLOR_HEADER,                   CRF_REGEX },
  { "index",                     MT_COLOR_INDEX,                    CRF_REGEX },
  { "index_author",              MT_COLOR_INDEX_AUTHOR,             CRF_REGEX },
  { "index_collapsed",           MT_COLOR_INDEX_COLLAPSED,          CRF_REGEX },
  { "index_date",                MT_COLOR_INDEX_DATE,               CRF_REGEX },
  { "index_flags",               MT_COLOR_INDEX_FLAGS,              CRF_REGEX },
  { "index_label",               MT_COLOR_INDEX_LABEL,              CRF_REGEX },
  { "index_number",              MT_COLOR_INDEX_NUMBER,             CRF_REGEX },
  { "index_size",                MT_COLOR_INDEX_SIZE,               CRF_REGEX },
  { "index_subject",             MT_COLOR_INDEX_SUBJECT,            CRF_REGEX },
  { "index_tag",                 MT_COLOR_INDEX_TAG,                CRF_REGEX },
  { "index_tags",                MT_COLOR_INDEX_TAGS,               CRF_REGEX },
  { "indicator",                 MT_COLOR_INDICATOR,                CRF_SIMPLE },
  { "italic",                    MT_COLOR_ITALIC,                   CRF_SIMPLE },
  { "markers",                   MT_COLOR_MARKERS,                  CRF_SIMPLE },
  { "message",                   MT_COLOR_MESSAGE,                  CRF_SIMPLE },
  { "normal",                    MT_COLOR_NORMAL,                   CRF_SIMPLE },
  { "options",                   MT_COLOR_OPTIONS,                  CRF_SIMPLE },
  { "progress",                  MT_COLOR_PROGRESS,                 CRF_SIMPLE },
  { "prompt",                    MT_COLOR_PROMPT,                   CRF_SIMPLE },
  { "quoted0",                   MT_COLOR_QUOTED0,                  CRF_SIMPLE },
  { "quoted1",                   MT_COLOR_QUOTED1,                  CRF_SIMPLE },
  { "quoted2",                   MT_COLOR_QUOTED2,                  CRF_SIMPLE },
  { "quoted3",                   MT_COLOR_QUOTED3,                  CRF_SIMPLE },
  { "quoted4",                   MT_COLOR_QUOTED4,                  CRF_SIMPLE },
  { "quoted5",                   MT_COLOR_QUOTED5,                  CRF_SIMPLE },
  { "quoted6",                   MT_COLOR_QUOTED6,                  CRF_SIMPLE },
  { "quoted7",                   MT_COLOR_QUOTED7,                  CRF_SIMPLE },
  { "quoted8",                   MT_COLOR_QUOTED8,                  CRF_SIMPLE },
  { "quoted9",                   MT_COLOR_QUOTED9,                  CRF_SIMPLE },
  { "search",                    MT_COLOR_SEARCH,                   CRF_SIMPLE },
  { "sidebar_background",        MT_COLOR_SIDEBAR_BACKGROUND,       CRF_SIMPLE },
  { "sidebar_divider",           MT_COLOR_SIDEBAR_DIVIDER,          CRF_SIMPLE },
  { "sidebar_flagged",           MT_COLOR_SIDEBAR_FLAGGED,          CRF_SIMPLE },
  { "sidebar_highlight",         MT_COLOR_SIDEBAR_HIGHLIGHT,        CRF_SIMPLE },
  { "sidebar_indicator",         MT_COLOR_SIDEBAR_INDICATOR,        CRF_SIMPLE },
  { "sidebar_new",               MT_COLOR_SIDEBAR_NEW,              CRF_SIMPLE },
  { "sidebar_ordinary",          MT_COLOR_SIDEBAR_ORDINARY,         CRF_SIMPLE },
  { "sidebar_spool_file",        MT_COLOR_SIDEBAR_SPOOL_FILE,       CRF_SIMPLE },
  { "sidebar_unread",            MT_COLOR_SIDEBAR_UNREAD,           CRF_SIMPLE },
  { "signature",                 MT_COLOR_SIGNATURE,                CRF_SIMPLE },
  { "status",                    MT_COLOR_STATUS,                   CRF_REGEX | CRF_BACK_REF },
  { "stripe_even",               MT_COLOR_STRIPE_EVEN,              CRF_SIMPLE },
  { "stripe_odd",                MT_COLOR_STRIPE_ODD,               CRF_SIMPLE },
  { "tilde",                     MT_COLOR_TILDE,                    CRF_SIMPLE },
  { "tree",                      MT_COLOR_TREE,                     CRF_SIMPLE },
  { "underline",                 MT_COLOR_UNDERLINE,                CRF_SIMPLE },
  { "warning",                   MT_COLOR_WARNING,                  CRF_SIMPLE },

  // Deprecated
  { "quoted",                    MT_COLOR_QUOTED0,                  CRF_SYNONYM },
  { "sidebar_spoolfile",         MT_COLOR_SIDEBAR_SPOOL_FILE,       CRF_SYNONYM },
  { NULL, 0 },
  // clang-format on
};
