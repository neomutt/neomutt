...
static const struct Command CompCommands[] = {
  // clang-format off
  { "append-hook", mutt_parse_hook_compress, MUTT_APPEND_HOOK },
  { "close-hook",  mutt_parse_hook_compress, MUTT_CLOSE_HOOK },
  { "open-hook",   mutt_parse_hook_compress, MUTT_OPEN_HOOK },
  { NULL, NULL, 0 },
  // clang-format on
};
