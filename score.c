 ...
 */
enum CommandResult parse_score(const struct Command *cmd, struct Buffer *token_,
 ...
 */
enum CommandResult parse_unscore(const struct Command *cmd, struct Buffer *token_,
                                 struct Buffer *line, struct Buffer *err)
{
  if (!MoreArgs(line))
  {
