...
#define OPS_SIDEBAR(_fmt) \
  ...
  /* L10N: Help for Sidebar function: <sidebar-select-entry> */ \
  _fmt(OP_SIDEBAR_SELECT_ENTRY,               N_("Open highlighted mailbox")) \
  ...
  /* L10N: Help for Sidebar function: <sidebar-select-next-new> */ \
  _fmt(OP_SIDEBAR_SELECT_NEXT_NEW,            N_("Move the highlight to next mailbox with new mail")) \
  ...
  /* L10N: Help for Sidebar function: <sidebar-select-previous-new> */ \
  _fmt(OP_SIDEBAR_SELECT_PREVIOUS_NEW,        N_("Move the highlight to previous mailbox with new mail")) \
