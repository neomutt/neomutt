...
const char *name_expando_uid_alias(int uid)
{
  switch (uid)
  {
    ...
    DEBUG_NAME(ED_ALI_ALIAS);
    DEBUG_NAME(ED_ALI_COMMENT);
    DEBUG_NAME(ED_ALI_EMAIL);
...
const char *name_expando_uid_global(int uid)
{
  switch (uid)
  {
    ...
    DEBUG_NAME(ED_GLO_PADDING_EOL);
    DEBUG_NAME(ED_GLO_PADDING_HARD);
    DEBUG_NAME(ED_GLO_PADDING_SOFT);
    DEBUG_NAME(ED_GLO_PADDING_SPACE);
...
const char *name_expando_uid_index(int uid)
{
  switch (uid)
  {
    ...
    DEBUG_NAME(ED_IND_UNREAD_MAILBOXES);
    DEBUG_DEFAULT;
  }
}
...
const char *name_expando_uid_pgp_key(int uid)
{
  switch (uid)
  {
    ...
    DEBUG_NAME(ED_PGK_KEY_FINGERPRINT);
