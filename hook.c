...
static const struct Command HookCommands[] = {
  // clang-format off
  { "account-hook",      "Run a command when switching to a matching account",                     mutt_parse_hook,               MUTT_ACCOUNT_HOOK                     },
  { "charset-hook",      "Define charset alias for languages",                                     mutt_parse_charset_iconv_hook, MUTT_CHARSET_HOOK                     },
  { "crypt-hook",        "Specify which keyid to use for recipients matching regex",               mutt_parse_hook,               MUTT_CRYPT_HOOK                       },
  { "fcc-hook",          "Pattern rule to set the save location for outgoing mail",                mutt_parse_hook,               MUTT_FCC_HOOK                         },
  { "fcc-save-hook",     "Equivalent to both fcc-hook and save-hook",                              mutt_parse_hook,               MUTT_FCC_HOOK | MUTT_SAVE_HOOK        },
  { "folder-hook",       "Run a command upon entering a folder matching regex",                    mutt_parse_hook,               MUTT_FOLDER_HOOK                      },
  { "iconv-hook",        "Define a system-specific alias for a character set",                     mutt_parse_charset_iconv_hook, MUTT_ICONV_HOOK                       },
  { "index-format-hook", "Create dynamic index format strings",                                    mutt_parse_idxfmt_hook,        MUTT_IDXFMTHOOK                       },
  { "mbox-hook",         "On leaving a mailbox, move read messages matching a regex regex",        mutt_parse_hook,               MUTT_MBOX_HOOK                        },
  { "message-hook",      "Run a command when viewing a message matching patterns",                 mutt_parse_hook,               MUTT_MESSAGE_HOOK                     },
  { "pgp-hook",          "Deprecated: Use crypt-hook",                                             mutt_parse_hook,               MUTT_CRYPT_HOOK                       },
  { "reply-hook",        "Run a command when replying to messages matching a pattern",             mutt_parse_hook,               MUTT_REPLY_HOOK                       },
  { "save-hook",         "Set default save folder for messages",                                   mutt_parse_hook,               MUTT_SAVE_HOOK                        },
  { "send-hook",         "Run a command when sending a message, new or reply, matching a pattern", mutt_parse_hook,               MUTT_SEND_HOOK                        },
  { "send2-hook",        "Run command whenever a composed message is edited",                      mutt_parse_hook,               MUTT_SEND2_HOOK                       },
  { "shutdown-hook",     "Run a command before NeoMutt exits",                                     mutt_parse_hook,               MUTT_SHUTDOWN_HOOK | MUTT_GLOBAL_HOOK },
  { "startup-hook",      "Run a command when NeoMutt starts up",                                   mutt_parse_hook,               MUTT_STARTUP_HOOK | MUTT_GLOBAL_HOOK  },
  { "timeout-hook",      "Run a command after a specified timeout or idle period",                 mutt_parse_hook,               MUTT_TIMEOUT_HOOK | MUTT_GLOBAL_HOOK  },
  { "unhook",            "Remove hooks of a given type",                                           mutt_parse_unhook,             0                                     },
  { NULL, NULL, NULL, 0 },
  // clang-format on
};
