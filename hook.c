...
static const struct Command HookCommands[] = {
  // clang-format off
  { "account-hook",      "Run commands when connecting to an account",  mutt_parse_hook,               MUTT_ACCOUNT_HOOK },
  { "charset-hook",      "Define charset alias for languages",          mutt_parse_charset_iconv_hook, MUTT_CHARSET_HOOK },
  { "crypt-hook",        "Define encryption key for address",           mutt_parse_hook,               MUTT_CRYPT_HOOK },
  { "fcc-hook",          "Save a copy of outgoing mail to a folder",    mutt_parse_hook,               MUTT_FCC_HOOK },
  { "fcc-save-hook",     "Combine fcc-hook and save-hook",              mutt_parse_hook,               MUTT_FCC_HOOK | MUTT_SAVE_HOOK },
  { "folder-hook",       "Run commands when opening a folder",          mutt_parse_hook,               MUTT_FOLDER_HOOK },
  { "iconv-hook",        "Define iconv alias for languages",            mutt_parse_charset_iconv_hook, MUTT_ICONV_HOOK },
  { "index-format-hook", "Dynamic index format strings",                mutt_parse_idxfmt_hook,        MUTT_IDXFMTHOOK },
  { "mbox-hook",         "Move read emails to a folder",                mutt_parse_hook,               MUTT_MBOX_HOOK },
  { "message-hook",      "Run commands before email is displayed",      mutt_parse_hook,               MUTT_MESSAGE_HOOK },
  { "pgp-hook",          "Deprecated alias to crypt-hook",              mutt_parse_hook,               MUTT_CRYPT_HOOK },
  { "reply-hook",        "Run commands when replying to an email",      mutt_parse_hook,               MUTT_REPLY_HOOK },
  { "save-hook",         "Set default save folder for messages",        mutt_parse_hook,               MUTT_SAVE_HOOK },
  { "send-hook",         "Run commands before sending an email",        mutt_parse_hook,               MUTT_SEND_HOOK },
  { "send2-hook",        "Run commands when compose message is edited", mutt_parse_hook,               MUTT_SEND2_HOOK },
  { "shutdown-hook",     "Run commands before NeoMutt exits",           mutt_parse_hook,               MUTT_SHUTDOWN_HOOK | MUTT_GLOBAL_HOOK },
  { "startup-hook",      "Run commands when NeoMutt starts",            mutt_parse_hook,               MUTT_STARTUP_HOOK | MUTT_GLOBAL_HOOK },
  { "timeout-hook",      "Run commands after idle timeout period",      mutt_parse_hook,               MUTT_TIMEOUT_HOOK | MUTT_GLOBAL_HOOK },
