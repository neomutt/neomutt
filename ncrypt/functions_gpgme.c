...
/**
 * op_quit - Save changes and exit this dialog - Implements ::gpgme_function_t - @ingroup gpgme_function_api
 */
...
static const struct GpgmeFunction GpgmeFunctions[] = {
  ...
  { OP_PGP_DISPLAY_DETAILS,        op_verify_key },
  { OP_EXIT,                   op_quit },
  { OP_QUIT,                   op_quit },
  { OP_PGP_SHOW_IDENTITY,          op_view_id },
  { 0, NULL },
  // clang-format on
};
