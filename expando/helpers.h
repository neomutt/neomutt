...
get_number_t                    find_get_number (const struct ExpandoRenderCallback *rcall, int uid);
get_string_t                    find_get_string (const struct ExpandoRenderCallback *rcall, int uid);
