...
/**
 * node_condbool_parse - Parse a CondDate format string - Implements ExpandoDefinition::parse - @ingroup expando_parse_api
 */
...
/**
 * node_expando_render - Callback for every bool node - Implements ExpandoNode::render - @ingroup expando_render
 */
