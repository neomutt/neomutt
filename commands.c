...
static const struct Command MuttCommands[] = {
  // clang-format off
  { "alias",               "Define an alias (name to email address)",                  parse_alias,            0                        },
  { "alternates",          "Define a list of alternate email addresses for the user",  parse_alternates,       0                        },
  { "alternative_order",   "Set preference order for multipart alternatives",          parse_stailq,           IP &AlternativeOrderList },
  { "attachments",         "Set attachment counting rules",                            parse_attachments,      0                        },
  { "auto_view",           "Automatically display specified MIME types inline",        parse_stailq,           IP &AutoViewList         },
  { "cd",                  "Change NeoMutt's current working directory",               parse_cd,               0                        },
  { "color",               "Define colors for the user interface",                     parse_color,            0                        },
  { "echo",                "Print a message to the status line",                       parse_echo,             0                        },
  { "finish",              "Stop reading current config file",                         parse_finish,           0                        },
  { "group",               "Add addresses to an address group",                        parse_group,            MUTT_GROUP               },
  { "hdr_order",           "Define custom order of headers displayed",                 parse_stailq,           IP &HeaderOrderList      },
  { "ifdef",               "Conditionally include config commands if symbol defined",  parse_ifdef,            0                        },
  { "ifndef",              "Conditionally include if symbol is not defined",           parse_ifdef,            1                        },
  { "ignore",              "Hide specified headers when displaying messages",          parse_ignore,           0                        },
  { "lists",               "Add address to the list of mailing lists",                 parse_lists,            0                        },
  { "mailboxes",           "Define a list of mailboxes to watch",                      parse_mailboxes,        0                        },
  { "mailto_allow",        "Permit specific header-fields in mailto URL processing",   parse_stailq,           IP &MailToAllow          },
  { "mime_lookup",         "Map specified MIME types/subtypes to display handlers",    parse_stailq,           IP &MimeLookupList       },
  { "mono",                "Deprecated: Use color",                                    parse_mono,             0                        },
  { "my_hdr",              "Add a custom header to outgoing messages",                 parse_my_hdr,           0                        },
  { "named-mailboxes",     "Define a list of labelled mailboxes to watch",             parse_mailboxes,        MUTT_NAMED               },
  { "nospam",              "Remove a spam detection rule",                             parse_nospam,           0                        },
  { "reset",               "Reset a config option to its initial value",               parse_set,              MUTT_SET_RESET           },
  { "score",               "Set a score value on emails matching a pattern",           parse_score,            0                        },
  { "set",                 "Set a config variable",                                    parse_set,              MUTT_SET_SET             },
  { "setenv",              "Set an environment variable",                              parse_setenv,           MUTT_SET_SET             },
  { "source",              "Read and execute commands from a config file",             parse_source,           0                        },
  { "spam",                "Define rules to parse spam detection headers",             parse_spam,             0                        },
  { "subjectrx",           "Apply regex-based rewriting to message subjects",          parse_subjectrx_list,   0                        },
  { "subscribe",           "Add address to the list of subscribed mailing lists",      parse_subscribe,        0                        },
  { "tag-formats",         "Define expandos tags",                                     parse_tag_formats,      0                        },
  { "tag-transforms",      "Rules to transform tags into icons",                       parse_tag_transforms,   0                        },
  { "toggle",              "Toggle the value of a boolean/quad config option",         parse_set,              MUTT_SET_INV             },
  { "unalias",             "Remove an alias definition",                               parse_unalias,          0                        },
  { "unalternates",        "Remove addresses from alternates list",                    parse_unalternates,     0                        },
  { "unalternative_order", "Remove MIME types from preference order",                  parse_unstailq,         IP &AlternativeOrderList },
  { "unattachments",       "Remove attachment counting rules",                         parse_unattachments,    0                        },
  { "unauto_view",         "Remove MIME types from auto_view list",                    parse_unstailq,         IP &AutoViewList         },
  { "uncolor",             "Remove a color definition",                                parse_uncolor,          0                        },
  { "ungroup",             "Remove addresses from an address group",                   parse_group,            MUTT_UNGROUP             },
  { "unhdr_order",         "Remove header from hdr_order list",                        parse_unstailq,         IP &HeaderOrderList      },
  { "unignore",            "Remove a header from the hdr_order list",                  parse_unignore,         0                        },
  { "unlists",             "Remove address from the list of mailing lists",            parse_unlists,          0                        },
  { "unmailboxes",         "Remove mailboxes from the watch list",                     parse_unmailboxes,      0                        },
  { "unmailto_allow",      "Disallow header-fields in mailto processing",              parse_unstailq,         IP &MailToAllow          },
  { "unmime_lookup",       "Remove custom MIME-type handlers",                         parse_unstailq,         IP &MimeLookupList       },
  { "unmono",              "Deprecated: Use uncolor",                                  parse_unmono,           0                        },
  { "unmy_hdr",            "Remove a header previously added with my_hdr",             parse_unmy_hdr,         0                        },
  { "unscore",             "Remove scoring rules for matching patterns",               parse_unscore,          0                        },
  { "unset",               "Reset a config option to false/empty",                     parse_set,              MUTT_SET_UNSET           },
  { "unsetenv",            "Unset an environment variable",                            parse_setenv,           MUTT_SET_UNSET           },
  { "unsubjectrx",         "Remove subject-rewriting rules",                           parse_unsubjectrx_list, 0                        },
  { "unsubscribe",         "Remove address from the list of subscribed mailing lists", parse_unsubscribe,      0                        },
  { "version",             "Show NeoMutt version and build information",               parse_version,          0                        },
  { NULL, NULL, NULL, 0 },
  // clang-format on
};
