...
static const struct Command MuttCommands[] = {
  // clang-format off
  { "alias",               "Create an email address alias",                      parse_alias,            0 },
  { "alternates",          "Mark addresses that match as yours",                 parse_alternates,       0 },
  ...
  { "auto_view",           "Automatically display MIME types using mailcap",     parse_stailq,           IP &AutoViewList },
  { "cd",                  "Change the current working directory",               parse_cd,               0 },
  { "color",               "Define colors for the user interface",               parse_color,            0 },
  { "echo",                "Print a message",                                    parse_echo,             0 },
  { "finish",              "Stop reading current config file",                   parse_finish,           0 },
  { "group",               "Add addresses to a group",                           parse_group,            MUTT_GROUP },
  { "hdr_order",           "Set the display order of email headers",             parse_stailq,           IP &HeaderOrderList },
  { "ifdef",               "Conditional execution if symbol is defined",         parse_ifdef,            0 },
  { "ifndef",              "Conditional execution if symbol is not defined",     parse_ifdef,            1 },
  { "ignore",              "Ignore email headers when displaying",               parse_ignore,           0 },
  { "lists",               "Mark addresses as belonging to mailing lists",       parse_lists,            0 },
  { "mailboxes",           "Add folders to the mailbox list",                    parse_mailboxes,        0 },
  { "mailto_allow",        "Allow headers in mailto: links",                     parse_stailq,           IP &MailToAllow },
  { "mime_lookup",         "Look up MIME type by file extension",                parse_stailq,           IP &MimeLookupList },
  { "mono",                "Define attributes for mono terminals",               parse_mono,             0 },
  { "my_hdr",              "Add a custom email header",                          parse_my_hdr,           0 },
  { "named-mailboxes",     "Add named folders to the mailbox list",              parse_mailboxes,        MUTT_NAMED },
  { "nospam",              "Remove a spam detection pattern",                    parse_nospam,           0 },
  ...
  { "source",              "Read a config file",                                 parse_source,           0 },
  { "spam",                "Define a spam detection pattern",                    parse_spam,             0 },
  { "subjectrx",           "Set subject substitution for index view",            parse_subjectrx_list,   0 },
  { "subscribe",           "Mark mailing lists as subscribed",                   parse_subscribe,        0 },
  { "tag-formats",         "Set format for notmuch tags",                        parse_tag_formats,      0 },
  { "tag-transforms",      "Set display transforms for notmuch tags",            parse_tag_transforms,   0 },
  { "toggle",              "Toggle the value of a boolean config variable",      parse_set,              MUTT_SET_INV },
  { "unalias",             "Remove an email address alias",                      parse_unalias,          0 },
  ...
  { "ungroup",             "Remove addresses from a group",                      parse_group,            MUTT_UNGROUP },
  { "unhdr_order",         "Remove headers from the display order list",         parse_unstailq,         IP &HeaderOrderList },
  { "unignore",            "Stop ignoring specific email headers",               parse_unignore,         0 },
  { "unlists",             "Remove addresses from the mailing list",             parse_unlists,          0 },
  { "unmailboxes",         "Remove folders from the mailbox list",               parse_unmailboxes,      0 },
  { "unmailto_allow",      "Disallow headers in mailto: links",                  parse_unstailq,         IP &MailToAllow },
  { "unmime_lookup",       "Remove MIME types from lookup list",                 parse_unstailq,         IP &MimeLookupList },
  { "unmono",              "Remove a mono definition",                           parse_unmono,           0 },
  { "unmy_hdr",            "Remove a custom email header",                       parse_unmy_hdr,         0 },
  { "unscore",             "Remove score rules",                                 parse_unscore,          0 },
  { "unset",               "Unset a config variable",                            parse_set,              MUTT_SET_UNSET },
  { "unsetenv",            "Unset an environment variable",                      parse_setenv,           MUTT_SET_UNSET },
  { "unsubjectrx",         "Remove subject substitution patterns",               parse_unsubjectrx_list, 0 },
  { "unsubscribe",         "Remove mailing lists from subscribed status",        parse_unsubscribe,      0 },
  { "version",             "Print NeoMutt's version",                            parse_version,          0 },
  { NULL, NULL, NULL, 0 },
  // clang-format on
};
