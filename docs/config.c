...
** .dt \fCalias\fP    .dd Alias short name
** .dt \fCemail\fP    .dd Email Address
** .dt \fCname\fP     .dd Real Name
** .dt \fCunsorted\fP .dd The order the Aliases were configured
** .de
** .pp
** .dl
** .dt \fBDeprecated Value\fP .dd \fBUse this instead\fP
** .dt \fCaddress\fP          .dd \fCemail\fP
** .de
** .pp
** Prefixing the value with \fCreverse-\fP sorts the entries in reverse order,
** e.g. \fCset alias_sort = "reverse-alias"\fP
** .pp
...
** .dt \fCcount\fP    .dd Total message count
** .dt \fCdate\fP     .dd Date
** .dt \fCdesc\fP     .dd Description
** .dt \fCsize\fP     .dd Count of new messages
** .dt \fCnew\fP      .dd Size
** .dt \fCunsorted\fP .dd Unsorted
** .de
** .pp
** .dl
** .dt \fBDeprecated Value\fP .dd \fBUse this instead\fP
** .dt \fCunread\fP           .dd \fCnew\fP
** .de
** .pp
** Prefixing the value with \fCreverse-\fP sorts the entries in reverse order,
** e.g. \fCset browser_sort = "reverse-date"\fP
*/
...
** report. Levels 4,5 will be extremely verbose. A value of 0 disables logging.
** .pp
...
** .dt \fBValue\fP    .dd \fBSort by\fP
** .dt \fCcount\fP    .dd Total message count
** .dt \fCdesc\fP     .dd Mailbox description
** .dt \fCflagged\fP  .dd Count of flagged messages
** .dt \fCpath\fP     .dd Mailbox path (alphabetically)
** .dt \fCunread\fP   .dd Count of unread messages
** .dt \fCunsorted\fP .dd The order the mailboxes were configured
** .de
** .pp
** .dl
** .dt \fBDeprecated Value\fP .dd \fBUse this instead\fP
** .dt \fCalpha\fP            .dd \fCpath\fP
** .dt \fCmailbox-order\fP    .dd \fCunsorted\fP
** .dt \fCname\fP             .dd \fCpath\fP
** .dt \fCnew\fP              .dd \fCunread\fP
** .de
** .pp
*/
...
** .dl
** .dt \fBValue\fP         .dd \fBSort by\fP
** .dt \fCdate\fP          .dd The date the email was sent
** .dt \fCdate-received\fP .dd When the message was delivered locally
** .dt \fCfrom\fP          .dd The email's From field
** .dt \fClabel\fP         .dd The emails label
** .dt \fCscore\fP         .dd The email's score
** .dt \fCsize\fP          .dd The size of the email
** .dt \fCspam\fP          .dd The email's spam score
** .dt \fCsubject\fP       .dd The email's subject
** .dt \fCthreads\fP       .dd Email threads
** .dt \fCto\fP            .dd The email's To field
** .dt \fCunsorted\fP      .dd The order the messages appear in the mailbox
** .de
** .pp
** .dl
** .dt \fBDeprecated Value\fP .dd \fBUse this instead\fP
** .dt \fCdate-sent\fP        .dd \fCdate\fP
** .dt \fCmailbox-order\fP    .dd \fCunsorted\fP
** .de
** .pp
