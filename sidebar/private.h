...
// commands.c
enum CommandResult parse_sidebar_unpin(struct Buffer *buf, struct Buffer *line, intptr_t data, struct Buffer *err);
enum CommandResult parse_sidebar_pin  (struct Buffer *buf, struct Buffer *line, intptr_t data, struct Buffer *err);
