...
static const struct Command SbCommands[] = {
  // clang-format off
  { "sidebar_pin",   "Pin a mailbox in the sidebar (keep visible)",      sb_parse_sidebar_pin,   0 },
  { "sidebar_unpin", "Unpin a previously pinned mailbox in the sidebar", sb_parse_sidebar_unpin, 0 },

  // Deprecated
  { "sidebar_whitelist",   "Deprecated: Use sidebar_pin",   sb_parse_sidebar_pin,   0 },
  { "unsidebar_whitelist", "Deprecated: Use sidebar_unpin", sb_parse_sidebar_unpin, 0 },
  { NULL, NULL, NULL, 0 },
  // clang-format on
};
