...
static const struct MenuFuncOp OpSidebar[] = { /* map: sidebar */
  ...
  { "sidebar-select-entry",               OP_SIDEBAR_SELECT_ENTRY },
  ...
  { "sidebar-select-next-new",            OP_SIDEBAR_SELECT_NEXT_NEW },
  ...
  { "sidebar-select-previous-new",        OP_SIDEBAR_SELECT_PREVIOUS_NEW },
  ...
  { "sidebar-next-new",                   OP_SIDEBAR_SELECT_NEXT_NEW,       MFF_DEPRECATED },
  { "sidebar-open",                       OP_SIDEBAR_SELECT_ENTRY,          MFF_DEPRECATED },
  ...
  { "sidebar-prev-new",                   OP_SIDEBAR_SELECT_PREVIOUS_NEW,   MFF_DEPRECATED },
...
static const struct SidebarFunction SidebarFunctions[] = {
  ...
  { OP_SIDEBAR_SEARCH,                     op_sidebar_start_search },
  { OP_SIDEBAR_SELECT_ENTRY,               op_sidebar_open },
  { OP_SIDEBAR_SELECT_FIRST_ENTRY,         op_sidebar_first },
  { OP_SIDEBAR_SELECT_LAST_ENTRY,          op_sidebar_last },
  { OP_SIDEBAR_SELECT_NEXT_ENTRY,          op_sidebar_next },
  { OP_SIDEBAR_SELECT_NEXT_NEW,            op_sidebar_next_new },
  ...
  { OP_SIDEBAR_SELECT_PREVIOUS_ENTRY,      op_sidebar_prev },
  { OP_SIDEBAR_SELECT_PREVIOUS_NEW,        op_sidebar_prev_new },
