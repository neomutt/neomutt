...
static int nntp_auth (NNTP_SERVER *nserv)
{
  ...
  while (1)
  {
    ...
    else if (nserv->hasCAPABILITIES != 0)
    {
			       ...
			       anum_t first, anum_t last, int restore)
{
      ...
      !nntp_data->deleted)
  {
    ...
    if (nntp_data->nserv->hasLISTGROUPrange != 0)
...
int nntp_check_new_groups (NNTP_SERVER *nserv)
{
  ...
  else if (nserv->newgroups_time != 0)
    return 0;
