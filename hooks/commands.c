...
const struct Command HooksCommands[] = {
  ...
  { "fcc-save-hook", CMD_FCC_SAVE_HOOK, parse_mailbox_hook, CMD_NO_DATA,
  ...
  { "iconv-hook", CMD_ICONV_HOOK, parse_charset_hook, CMD_NO_DATA,
        N_("Define a system-specific alias for a character set"),
        N_("iconv-hook <charset> <local-charset>"),
        "configuration.html#charset-hook" },
  { "index-format-hook", CMD_INDEX_FORMAT_HOOK, parse_index_hook, CMD_NO_DATA,
  ...
  { "mbox-hook", CMD_MBOX_HOOK, parse_mbox_hook, CMD_NO_DATA,
