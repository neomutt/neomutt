...
const struct Command HooksCommands[] = {
  ...
  { "fcc-save-hook", CMD_FCC_SAVE_HOOK, parse_mailbox_hook,
  ...
  { "iconv-hook", CMD_ICONV_HOOK, parse_charset_hook,
        N_("Define a system-specific alias for a character set"),
        N_("iconv-hook <charset> <local-charset>"),
        "configuration.html#charset-hook" },
  { "index-format-hook", CMD_INDEX_FORMAT_HOOK, parse_index_hook,
  ...
  { "mbox-hook", CMD_MBOX_HOOK, parse_mbox_hook,
